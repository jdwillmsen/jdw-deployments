...
| 2026-09-15 | [Bedrock version checks stopped when Mojang changed the default transport](2026-09-15-fwb-version-check-nethernet.md) | minecraft-fwb | none | Resolved; explicit `transport` still to be pinned |
